 ...
 * @author Cyrille
 */
public class EtatCommentaireLong implements Etat {
    ConstructeurHtml constructeur;

    public EtatCommentaireLong(ConstructeurHtml c) {
        constructeur = c;
    }
    @Override
    public void asterisque() {
        constructeur.setEtat(constructeur.getEtatSortieCommentaireLong());
    }
    @Override
    public void slash() {
